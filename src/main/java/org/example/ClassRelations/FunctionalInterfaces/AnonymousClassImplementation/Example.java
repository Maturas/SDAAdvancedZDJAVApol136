package org.example.ClassRelations.FunctionalInterfaces.AnonymousClassImplementation;

import org.example.ClassRelations.FunctionalInterfaces.TraditionalImplementation.Action;
...
public class Example {
    ...
    public static void doIf(Boolean condition, org.example.ClassRelations.FunctionalInterfaces.TraditionalImplementation.Action actionIfTrue, Action actionIfFalse) {
        if (condition) {
            actionIfTrue.invoke();
        }
        else {
